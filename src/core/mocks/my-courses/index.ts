...
export const academyData: AcademyType = {
  ...
  courses: {
    categories: [
      { id: 1, title: 'Todos os cursos', slug: 'todos' },
      { id: 2, title: 'Atual', slug: 'atual' },
      { id: 3, title: 'Arquivada', slug: 'arquivada' },
      { id: 4, title: 'Por vir', slug: 'por vir' },
      { id: 5, title: 'Lista de observação', slug: 'Lista de observação' },
    ],
    courses: [
      {
        id: 1,
        title: 'UI e UX Designing',
      ...
      {
        id: 2,
        title: 'Design de logotipo (parte 1)',
